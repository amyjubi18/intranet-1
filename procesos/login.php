...
if(isset($_POST["submit"])){
    ...
    if($resultado->num_rows > 0){
        ...
        echo "<script> 
        alert('El correo o la contraseña es incorrecta') </script>";
    }
}
?>
            ...
            <div class="w-full h-200  touch-none">
                ...
                <form class="mt-0" action="#" method="POST">
                    <div class="mt-1">
                        ...
                        <input type="text" placeholder="Ingresa el Correo" class="w-full bg-gray-200 mt-2 border focus:border-blue-900 focus:bg-white focus:outline-none rounded-lg px-4 py-3" autocomplete autofocus required name="correo" id="correo">
                    </div>
                    <div class="mt-1">
                        <label class="block text-gray-700">Contraseña:</label>
                        <input type="password" minlength="6" placeholder="Ingresa la Contraseña"  class="w-full bg-gray-200 mt-2 border focus:border-blue-900 focus:bg-white focus:outline-none rounded-lg px-4 py-3" required name="contrasena" id="contrasena">
                    </div>
                    ...
                    <button class="w-full block bg-blue-900 hover:bg-blue-800 px-4 py-3 mt-4 rounded-lg font-semibold text-white focus:bg-blue-400 focus:outline-none" type="submit" name="submit" id="submit">Ingresar</button>
